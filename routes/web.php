...
Route::get('/email', [AdminController::class,'Email'])->name('admin.email')->middleware('AdminMiddleware');
...
Route::POST('/email', [EmailController::class,'emailSubmit'])->name('admin.emailSubmit');
